...
RULE 2 — VERBATIM SKILLS: Copy each skill bullet using only the student's exact words. Never add, expand, or elaborate. "Responsible" → "Responsible". "Fast learner" → "Fast learner". Adding even one word not in the student's input is a critical violation.
